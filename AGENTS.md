...
The current active Course 3 manifest contains 43 learner-ready concepts:

- Rigid Transformations and Congruence: 4 concepts
...
question templates, one template dominating the bank, or challenge questions
